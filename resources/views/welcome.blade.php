...
<body class="min-h-screen bg-gray-100 dark:bg-gray-900">
    <div class="relative px-6 pt-0 lg:px-8">
        ...
        <div class="max-w-2xl py-48 mx-auto  sm:py-48 lg:py-56">
            <div class="text-center">
                ...
                <form class="flex items-center justify-center my-12 gap-x-3">
                    <div class="relative">
                        ...
                        <input type="text" placeholder="Enter your email" class="w-full py-2 pl-12 pr-3 text-gray-500 bg-transparent border rounded-lg shadow-sm outline-none focus:border-indigo-600" />
                    </div>
